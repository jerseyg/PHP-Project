...
<form name="post" action="php/insert.php" method="post" enctype="multipart/form-data">
   	Title: <input type="text" name="title" maxlength="30" /><br />
   	Image (Optional): <input type="hidden" name="img" maxlength="100" /><input type="file" name="file" id="file"/><br /><br />
