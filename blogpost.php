  ...
  <div class="row">
    ...
    <div class="nine columns" role="content">
      ...
      <article>
        ...
        <h3><a href="blogpost.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h3>
        <h6>Written by <a href="#"><?php echo $row['user']; ?></a>, <?php echo date("F-d-Y h:i:s A", $times); ?> <a href="#" class="delete_button">Delete</a><a href="#" class="edit_button">Edit</a></h6>
